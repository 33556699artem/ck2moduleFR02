...
let owner2 = new OwnerClass("Малышев", "Артём", "Павлович", date2, TypeOfDocument.passport, "1234", "567890");
let car = new CarCl("Cadillac", "XT5", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner2, BodyType.crossover, CarClass.Buisiness);
owner2.printOwnerInfo();
car.printVehicleInfo();

let date = new Date(2005, 2, 23);
let owner = new OwnerClass("Малышев", "Артём", "Павлович", date2, TypeOfDocument.passport, "1234", "567890");
