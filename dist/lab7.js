...
(function (Transport) {
    ...
    var CarCl = /** @class */ (function (_super) {
        ...
        CarCl.prototype.getInfoAboutBodyTypeAndCarClass = function () {
            return {
    ...
    var VehicleStorageCl = /** @class */ (function () {
        ...
        VehicleStorageCl.prototype.sortByModel = function () {
        ...
        VehicleStorageCl.prototype.getByMark = function (mark) {
            return this.vehicles.filter(function (v) { return v.getModel == mark; });
        };
        return VehicleStorageCl;
    }());
    Transport.VehicleStorageCl = VehicleStorageCl;
})(Transport || (exports.Transport = Transport = {}));
var owner1 = new Transport.OwnerClass("Малышев", "Артём", "Павлович", new Date(2005, 2, 23), Transport.TypeOfDocument.passport, "1234", "567890");
var car1 = new Transport.VehicleClass("BMW", "X7", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner1);
var car2 = new Transport.CarCl("Cadillac", "XT5", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner1, Transport.BodyType.crossover, Transport.CarClass.Buisiness);
var motorbike = new Transport.MotorbikeCl("Progasi Race", "300", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner1, "Дуплексная", true);
var storage = new Transport.VehicleStorageCl;
storage.addVehicle(car1);
storage.addVehicle(car2);
storage.addVehicle(motorbike);
var sorted = storage.sortByModel();
console.log(sorted);
var car3 = new Transport.CarCl("CADILLAC", "XT5", 2021, "0923FH028HFS0JBIF3347", "И123ВТ", owner1, Transport.BodyType.crossover, Transport.CarClass.Buisiness);
storage.addVehicle(car3);
var gbm = storage.getByMark("XT5");
console.log(gbm);
var info = car3.getInfoAboutBodyTypeAndCarClass();
console.log(info);
